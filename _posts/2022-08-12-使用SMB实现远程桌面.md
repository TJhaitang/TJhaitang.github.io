...
![功能不可用](https://raw.githubusercontent.com/TJhaitang/TJhaitang.github.io/refs/heads/master/_posts/images/使用SMB实现远程桌面/1.1.png)  
...
![以管理员身份运行](https://raw.githubusercontent.com/TJhaitang/TJhaitang.github.io/refs/heads/master/_posts/images/使用SMB实现远程桌面/1.2.png)      
安装完毕后，双击打开RDPConf.exe，如果程序显示 [fully supported] 则代表远程桌面服务已开启。然而十有八九是不可以的，还需要对Rdpwrap.ini进行配置。   
![检验通过](https://raw.githubusercontent.com/TJhaitang/TJhaitang.github.io/refs/heads/master/_posts/images/使用SMB实现远程桌面/1.3.png)     
...
![远程桌面连接](https://raw.githubusercontent.com/TJhaitang/TJhaitang.github.io/refs/heads/master/_posts/images/使用SMB实现远程桌面/1.4.png)   
